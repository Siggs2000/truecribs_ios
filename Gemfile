...
gem "ProMotion", :git => 'https://github.com/infinitered/redpotion.git'
...
#gem "ProMotion-form"
gem 'ProMotion-XLForm', :git => 'https://github.com/bmichotte/ProMotion-XLForm.git'
...
gem "bubble-wrap", require: %w[bubble-wrap/all]
